...
# 修复 Armbian 中的 mknod 命令以兼容 Ubuntu 26.04
# 同时保持对 Ubuntu 22.04 的兼容性
...
echo "Patching $LOOP_SH for Ubuntu 22.04/26.04 compatibility..."
...
replacement = '''# Ubuntu 22.04/26.04 兼容的 mknod 命令
